...
let s:palette.gray01 = [235, '#2C2C2C']
...
let s:palette.yellow = [89, '#FECF00']
...
call s:hi('Todo', s:palette.white, s:palette.black, '')
...
" call s:hi('LineNr', s:palette.white, 's:palette.black', 'bold')
call s:hi('LineNr', s:palette.white, '', 'bold')

call s:hi('FoldColumn', s:palette.gray07, s:palette.black, 'none')
call s:hi('CursorLine', [], s:palette.black, 'none')
call s:hi('CursorLineNr', s:palette.gray14, s:palette.black, 'none')

call s:hi('Visual', s:palette.black, s:palette.gray15, '')
...
call s:hi('Error', s:palette.gray11, s:palette.black, '')
call s:hi('ErrorMsg', s:palette.gray11, s:palette.black, '')
call s:hi('WarningMsg', s:palette.brown, s:palette.black, '')
call s:hi('ModeMsg', s:palette.gray10, [], '')
call s:hi('MoreMsg', s:palette.gray10, [], '')

call s:hi('MatchParen', s:palette.gray13, s:palette.black, '')
...
call s:hi('StatusLine', s:palette.white, s:palette.gray01, 'none')
call s:hi('StatusLineTab', s:palette.white, s:palette.black, 'none')
...
highlight! link TabLineSel StatusLineTab
